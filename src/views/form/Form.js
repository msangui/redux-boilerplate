...
class Form extends Component {
  ...
  handleSubmit(event) {
    ...
    if (Object.keys(errors).some(key => errors[key])) {
      ...
      console.info('Data submitted! ' + JSON.stringify(this.props.data));
      reset();
    }
  }
        ...
        <form className="form-horizontal" onSubmit={::this.handleSubmit}>
          <div className={'form-group' + (nameError && nameVisited ? ' has-error' : '')}>
            ...
            <div className="col-sm-10">
              <input type="text" className="form-control" id="name" value={name} onChange={handleChange('name')} onBlur={handleChange('name')}/>
          ...
          <div className={'form-group' + (emailError && emailVisited ? ' has-error' : '')}>
            ...
            <div className="col-sm-10">
              <input type="email" className="form-control" id="email" value={email} onChange={handleChange('email')} onBlur={handleChange('email')}/>
          ...
          <div className={'form-group' + (occupationError && occupationVisited ? ' has-error' : '')}>
            ...
            <div className="col-sm-10">
              <input type="text" className="form-control" id="occupation" value={occupation} onChange={handleChange('occupation')} onBlur={handleChange('occupation')}/>
